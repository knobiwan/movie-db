export const API_KEY = "api_key=98a315c12601a2ffeecdd86990b00e3e&language=de";
...
export const STREAMING_PROVIDER =
    API_BASE_URL + "/movie/{movieId}/watch/providers?" + API_KEY;
